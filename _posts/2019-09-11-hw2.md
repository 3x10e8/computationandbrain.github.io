...
----------
Here are some optional links that you might find interesting:

Jack Gallant's group has a recent bioRxiv paper on a similar model [The DeepTune framework for modeling and
