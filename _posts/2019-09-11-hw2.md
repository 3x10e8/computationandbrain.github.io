...
1. Watch [this talk by Bruno Olshausen](https://simons.berkeley.edu/talks/olshausen-neural) on the Neural Mechanisms of Vision. Summarize the parts of the talk that you find interesting. Be sure to include some of the following points:
  1. What is an "ON" cell and an "OFF" cell?
  2. What is the main result of the "Efficient Coding Model of Retina" (Karklin and Simoncelli 2012) mentioned in the talk?
